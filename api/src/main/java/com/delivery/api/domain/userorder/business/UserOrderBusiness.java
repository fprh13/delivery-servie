...
import com.delivery.api.domain.userordermenu.serverce.UserOrderMenuService;
    ...
    public List<UserOrderDetailResponse> current(User user) {
        ...
        var userOrderDetailResponseList = userOrderEntityList.stream().map(userOrderEntity -> {
            ...
            return UserOrderDetailResponse.builder()
                    ...
                    .storeMenuResponseList(Collections.singletonList(storeMenuConverter.toResponse((StoreMenuEntity) storeMenuEntityList)))
